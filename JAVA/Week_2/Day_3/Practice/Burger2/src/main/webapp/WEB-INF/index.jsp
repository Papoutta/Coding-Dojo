...
<div class="container p-5">
			...
			<c:forEach items="${allBurgers}" var="one" >
				<tr>
					...
					<td>
						...
						<a class="btn btn-primary" href='/burger/edit/${one.id}'>Edit</a>
						<form action="/burger/delete/${one.id}" method="POST">
	...
	<h1 class="p-3">Add Burger</h1>
		<form:form class="col-6 border rounded-4 border-dark p-5" action="/burger/processBurger" method="post" modelAttribute="burger">
